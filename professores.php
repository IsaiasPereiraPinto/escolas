 ...
 */
    ...
    class professoresPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Professores');
            $this->SetMenuLabel('Professores');
            ...
            $this->dataset->addFields(
                array(
                    ...
                    new StringField('professor', true)
                )
            );
        }
    ...
    try
    {
        $Page = new professoresPage("professores", "professores.php", GetCurrentUserPermissionsForPage("professores"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("professores"));
