...
{
    $result = array();
    $result[] = array('caption' => 'Alunos', 'short_caption' => 'Alunos', 'filename' => 'alunos.php', 'name' => 'alunos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Cursos', 'short_caption' => 'Cursos', 'filename' => 'cursos.php', 'name' => 'cursos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Escola', 'short_caption' => 'Escola', 'filename' => 'escola.php', 'name' => 'escola', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Professores', 'short_caption' => 'Professores', 'filename' => 'professores.php', 'name' => 'professores', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        '<h5>Desenvolvido por IPPSoftware @2021</h5>';
}
